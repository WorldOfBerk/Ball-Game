...
public class PlayerManager : MonoBehaviour
{
    ...
    private bool moveTheBall; //check the ball is moving??
    ...
    void Update()
    {
        ...
        if (moveTheBall)
        {
            ...
            if (newPlan.Raycast(ray, out var distance))
            {
                ...
                DesireBallPos.x = Mathf.Clamp(DesireBallPos.x, -1.9f, 1.9f);
        ...
        if (MenuManager.MenuManagerInstance.GameState)
        {
            ...
            ball.GetChild(1).Rotate(Vector3.right * 100f * Time.deltaTime);
        }
